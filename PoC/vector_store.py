...
class FaissVS:
    def __init__(self, embd_model_device="cuda:3") -> None:
    ...
    def create_vector_store(self, documents, path):
        self.set_settings()
    ...
    def load_index(self, vector_store_path):
    ...
    def get_retriever(self, similarity_top_k, vector_store_path=None):
...
if __name__ == "__main__":
    ...
    # faiss_vs.load_index("vector_store")
